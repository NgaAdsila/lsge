...
import my.lsge.application.exception.DropboxException;
...
public class DropboxServiceImpl implements DropboxService {
    ...
    @Override
    public DbxDownloader<FileMetadata> getPreview(String filePath) {
         return handleDropboxAction(() -> client.files().getPreview(filePath), String.format("Error get preview file: %s", filePath));
    }

    @Override
    public SharedLinkMetadata createShareLink(String filePath) {
        return handleDropboxAction(() -> client.sharing().createSharedLinkWithSettings(filePath),
                String.format("Error create shared link: %s", filePath));
    }
