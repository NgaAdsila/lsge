<template>
    <b-modal
            ...
            @ok="handleOk"
    >
        <b-form @submit.stop.prevent="onUpdatePost">
    ...
    export default {
        ...
        methods: {
            ...
            resetModal() {
                ...
                this.content = this.post.content || null
                this.shareMode = this.post.shareMode || POST.SHARE_MODE.PUBLIC
            },
            handleOk(bvModelEvt) {
            ...
            onUpdatePost() {
                ...
                this.$emit('updatePost', this.post.id, this.title, this.content, this.shareMode);
                this.$nextTick(() => {
                    this.$bvModal.hide('edit-post-modal-' + this.post.id)
                })
            },
            focusFirstError() {
